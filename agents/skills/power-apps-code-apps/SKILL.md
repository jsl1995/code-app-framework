...
Work through these phases in order. Each phase has a dedicated reference file in `agents/skills/`.
Read the relevant file before starting that phase.

| Phase | Reference File | Purpose |
|-------|---------------|---------|
| 1. Brainstorming | `agents/skills/brainstorming/SKILL.md` | Define the problem, users, scope, and success criteria |
| 2. Solution Architecture | `agents/skills/architecture/SKILL.md` | Component design, hosting model, ALM, security posture |
| 3. Data Architecture | `agents/skills/data-structure/SKILL.md` | Data sources, schema, delegation, relationships |
| 4. UI Mockups | `agents/skills/mock-up/SKILL.md` | Wireframes, component hierarchy, responsive layout |
| 5. Connectors & Data Sources | `agents/skills/connectors/SKILL.md` | Connector selection, connection references, generated services |
| 6. Scaffolding & Build | `agents/skills/implement-code/SKILL.md` | Project init, Copilot prompts, build, test, deploy |
| 7. Testing & QA | `agents/skills/testing/SKILL.md` | Unit, integration, E2E, UAT, and performance testing |
| 8. Accessibility & Compliance | `agents/skills/accessibility/SKILL.md` | WCAG 2.2 AA audit, ARIA patterns, compliance report |
| 9. Governance & Handover | `agents/skills/governance/SKILL.md` | Documentation, runbooks, naming conventions, change logs |
| 10. Coding Standards | `agents/skills/coding-standards/SKILL.md` | ESLint, Prettier, TypeScript config, PR review checklist |
| 11. Error Handling & Observability | `agents/skills/error-handling/SKILL.md` | Error taxonomy, retry logic, logging, Application Insights |
